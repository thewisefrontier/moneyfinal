...
def fetch_stock_prices(market: str, base_date: str, num_rows: int = 100) -> list:
    """주식시세정보 수집 - 시가총액 상위 종목"""
...
def main():
    ...
    all_prices = []
    for market in ['KOSPI', 'KOSDAQ']:
        items = fetch_stock_prices(market, base_date, 200)
        if items:
