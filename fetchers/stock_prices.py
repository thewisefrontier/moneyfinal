...
def fetch_stock_prices(market: str, base_date: str) -> list:
    url = f"{BASE_URL}/GetStockSecuritiesInfoService/getStockPriceInfo"
    params = {'resultType':'json','numOfRows':200,'pageNo':1,'basDt':base_date,'mrktCls':market}
    try:
...
def main():
    ...
    if all_prices: supabase_upsert('stock_prices', all_prices)
